...
export class GlassRenderer {
  ...
  private blurOpacityBoost: number = 0.25; // Stronger frosted effect for visibility (0.0-0.5)
  private blurDistortionBoost: number = 0.5; // Stronger distortion reduction for clarity (0.0-1.0)
